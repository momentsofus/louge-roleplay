...
function seedSqliteFonts(db) {
  const defaults = [
    ...
    ['ma-shan-zheng', 'Ma Shan Zheng · 马善政', '"Ma Shan Zheng", "STKaiti", "KaiTi", cursive', 'https://fonts.xuejourney.xin/css2?family=Ma+Shan+Zheng&display=swap', '马善政带着题字和手写感，适合更有江湖气的对白。', 50],
    ['zcool-xiaowei', 'ZCOOL XiaoWei · 站酷小薇', '"ZCOOL XiaoWei", "Songti SC", "SimSun", serif', 'https://fonts.xuejourney.xin/css2?family=ZCOOL+XiaoWei&display=swap', '站酷小薇像旧书标题，也适合温雅一点的叙事。', 60],
    ['zhi-mang-xing', 'Zhi Mang Xing · 志莽行', '"Zhi Mang Xing", "STKaiti", "KaiTi", cursive', 'https://fonts.xuejourney.xin/css2?family=Zhi+Mang+Xing&display=swap', '志莽行更潇洒，像把一句话写在风里。', 70],
    ['zcool-qingke-huangyou', 'ZCOOL QingKe HuangYou · 站酷庆科黄油体', '"ZCOOL QingKe HuangYou", "PingFang SC", "Microsoft YaHei", sans-serif', 'https://fonts.xuejourney.xin/css2?family=ZCOOL+QingKe+HuangYou&display=swap', '庆科黄油体轻快醒目，适合更活泼的聊天氛围。', 80],
    ['long-cang', 'Long Cang · 龙藏体', '"Long Cang", "STKaiti", "KaiTi", cursive', 'https://fonts.xuejourney.xin/css2?family=Long+Cang&display=swap', '龙藏体笔意更散，适合古风、梦境和带余韵的角色。', 90],
  ];
