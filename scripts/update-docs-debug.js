...
const FILE_NOTES = {
  ...
  'public/js/generated/admin.bundle.js': '后台交互聚合包：套餐字段切换、Prompt 片段排序/预览、后台列表过滤。',
  'public/js/admin/model-config.js': '后台模型与套餐模型表单交互源码。',
  'public/js/admin/prompt-blocks.js': 'Prompt 片段排序、拖拽和预览源码。',
  'public/js/admin/list-filter.js': '后台列表客户端筛选源码。',
  'public/js/admin/quota-bars.js': '后台额度条宽度源码。',
